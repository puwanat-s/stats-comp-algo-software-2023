...
and this result stays true even when there is no fixed seed. The estimate flutuates with a huge range when you increase or decrease the seed (for the case of theta = 1e10 + rnorn(1)). 
